...
[_QW] = { /* Qwerty */
  ...
  {SFT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,   CTL_T(KC_ESC),  KC_N,    KC_M,    KC_COMM, KC_DOT,  SFT_T(KC_SLSH) },
  {KC_TRNS, KC_TAB, KC_LGUI,  KC_TRNS, KC_BSPC,  ALT_T(KC_ENT), KC_SPC,  MO(_RS), KC_MINS, KC_QUOT, KC_TRNS  }
},
/*
 *  !       @     up     {    }       ||     pgup    7     8     9    *
...
[_RS] = { /* [> RAISE <] */
  ...
  {SFT_T(KC_LBRC), KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR, KC_LCTL, KC_GRV,  KC_1,    KC_2,   KC_3, SFT_T(KC_BSLS)},
  {TG(_LW), KC_INS,  KC_LGUI, KC_TRNS, KC_DEL, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL}
},
/*
